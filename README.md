...
|---|---|---|---|---|---|
| VFL | [Stalactite: Toolbox for Fast Prototyping of Vertical Federated Learning Systems]((https://dl.acm.org/doi/pdf/10.1145/3640457.3691700) | 2024 | RecSys | Code TBA | --- |
